...
% }
% \begin{tasks}
%   \task Design and build a robotic arm that is controlled with an Android phone. It is meant to showcase a prototype that can be scaled for production.
% \end{tasks}
% %
% %
% \subsection*{
...
% }
% \begin{tasks}
%   \task The project documents the process of designing and setting up the groundwork for a CNC Milling machine.
% \end{tasks}
% %
% %
% \subsection*{
...
% }
% \begin{tasks}
%   \task The objective of the project is to learn the basics of induction heating and build a prototype based on a high-end induction heater.
% \end{tasks}
